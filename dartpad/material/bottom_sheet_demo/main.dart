...
class _ExampleState extends State<Example> {
  ...
  static const String _title = 'Bottom Sheet Demonstration';

  @override
  void initState() {
    super.initState();
    _body = BottomSheetDemo(type: BottomSheetDemoType.persistent);
  }
        ...
        appBar: AppBar(
          ...
          actions: <Widget>[
            ...
            IconButton(
              ...
              onPressed: () {
                setState(() {
                  _body = BottomSheetDemo(type: BottomSheetDemoType.modal);
                });
              },
            ),
          ],
