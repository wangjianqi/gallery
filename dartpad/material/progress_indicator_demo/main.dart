...
class _ExampleState extends State<Example> {
	...
	static const String _title = 'Progress Indicator Demonstration';

	@override
	void initState() {
		super.initState();
		_body = ProgressIndicatorDemo(type:ProgressIndicatorDemoType.circular,);
	}
				...
				appBar: AppBar(
					...
					actions: <Widget>[
						...
						IconButton(
							...
							onPressed: () {
								setState(() {
									_body = ProgressIndicatorDemo(type:ProgressIndicatorDemoType.linear,);
								});
							},
						),
					],
